...
const TabsTrigger: FC<TabsPrimitive.TabsTriggerProps> = ({
  ...
  return (
    <TabsPrimitive.Trigger
      className={cn(
        'px-3 py-2 text-left text-slate-700 outline-none data-[state=active]:bg-slate-900 data-[state=active]:font-semibold data-[state=active]:text-light-gold dark:border-slate-800 dark:bg-slate-800 dark:text-slate-400 dark:data-[state=active]:bg-slate-200 dark:data-[state=active]:text-slate-900',
        className
      )}
      {...props}
    />
